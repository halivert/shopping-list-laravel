 ...
 * (with a time component, e.g. real instants like `updatedAt`) are left as-is.
 */
...
/**
 * Today's date as a local "YYYY-MM-DD" string. Never use `Date#toISOString`
 * for this — it serializes in UTC, which is the wrong calendar day for part
 * of the day in every timezone with a non-zero offset.
 */
